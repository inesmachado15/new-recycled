    ...
    return (
      <main className="min-h-screen bg-slate-50 px-6 py-12 text-slate-900">
        <section className="mx-auto max-w-5xl rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <h1 className="mt-4 text-3xl font-black">Produto não encontrado</h1>
          ...
          <button
            ...
            className="mt-6 rounded-full bg-green-700 px-6 py-3 text-sm font-bold text-white transition hover:bg-green-800"
          >
            Voltar ao catálogo
          </button>
        </section>
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-2">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-4 whitespace-pre-line text-sm leading-7 text-slate-600">
              {produto.description ||
                "Este produto ainda não tem descrição detalhada."}
            </p>
          </div>
